    <footer class="main-footer">
      <div class="container">
        <div class="upper-footer">
          ...
          <!--     <div class="link-head bb-head">
                ...
                <ul>
                  ...
                  <li><a href="javascript:;" class="foot-link">Bloggers</a></li>
                  <li><a href="javascript:;" class="foot-link">Pers</a></li>
            ...
            <!-- <div class="col col-sm-6 col-md-4 col-lg-2">
              <div class="link-head">
                ...
                <ul>
                  <li><a href="javascript:;" class="foot-link">Cowboysbag</a></li>
                  <li><a href="javascript:;" class="foot-link">Fjallraven</a></li>
                  <li><a href="javascript:;" class="foot-link">Guess</a></li>
                  <li><a href="javascript:;" class="foot-link">Michael Kors</a></li>
                  <li><a href="javascript:;" class="foot-link">Rains</a></li>
                  <li><a href="javascript:;" class="foot-link">Studio Noos</a></li>
                  <li><a href="javascript:;" class="foot-link">Ted Baker</a></li>
                  <li><a href="javascript:;" class="foot-link">UGG</a></li>
                  <li><a href="javascript:;" class="foot-link">Valentino Handbags</a></li>
                  <li><a href="javascript:;" class="foot-link">Zusss</a></li>
           ...
           <div class="in-mob-f">    
            ...
            <!--  <div class="accordion-item">
                  ...
                  <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                     <div class="accordion-body">
                        <ul id="b2b" class="benmenu">
                          <li class="cc"><a href="javascript:;">Originele kerstpakketten</a></li>
                          <li class="cc"><a href="javascript:;">Bloggers</a></li>
                          <li class="cc"><a href="javascript:;">Pers</a></li>
                          </ul>
                     </div>
                  </div>
               </div> -->
             ...
             <!--   <div class="accordion-item">
                  ...
                  <div id="collapseseven" class="accordion-collapse collapse" aria-labelledby="headingseven" data-bs-parent="#accordionExample">
                     <div class="accordion-body">
                       <ul id="brands" class=" benmenu">
                        <li class="cc"><a href="javascript:;">Cowboysbag</a></li>
                          <li class="cc"><a href="javascript:;">Fjallraven</a></li>
                          <li class="cc"><a href="javascript:;">Guess</a></li>
                          <li class="cc"><a href="javascript:;">Michael Kors</a></li>
                          <li class="cc"><a href="javascript:;">Rains</a></li>
                          <li class="cc"><a href="javascript:;">Studio Noos</a></li>
                          <li class="cc"><a href="javascript:;">Ted Baker</a></li>
                          <li class="cc"><a href="javascript:;">UGG</a></li>
                          <li class="cc"><a href="javascript:;">Valentino Handbags</a></li>
                          <li class="cc"><a href="javascript:;">Zusss</a></li>
                          <li class="cc"><a href="javascript:;"><u>Meer merken</u></a></li>
                       </ul>
                     </div>
                  </div>
               </div> -->
            ...
            <div class="col-12 col-md-12 col-lg-4">
              <div class="Nieuwsbrief">
                ...
                <ul class="list-inline">
                  ...
                  <label class="nbck" for="kids">Kids</label>
                  </li>
                  </ul>
                  <div class="nieuwsbrief">
        ...
        <div class="divbetaalwijze text-center">
      
        <span class="sprite postNL"></span>
        <span class="sprite ideal"></span>
        <span class="sprite visa"></span>
        <span class="sprite logo_mastercard"></span>
        <span class="sprite maestro"></span>
        <span class="sprite klarna"></span>
        <span class="sprite payconiq"></span>
        <span class="sprite paypal"></span>
        <span class="sprite applepay"></span>
        <span class="sprite americanExpress"></span>
        <span class="sprite bankcontact"></span>
        <span class="sprite fashionCheque"></span>
        <span class="sprite VVVCadeaubon"></span>
        <span class="sprite webshopGiftcard"></span>
        <span class="sprite yourGift"></span>
        <span class="sprite ippies"></span>
        <span class="sprite shoesAccessories"></span>
        <span class="sprite fashionGiftcard"></span>
        <span class="sprite VVV_Giftcard"></span>
        <span class="sprite winkelCheque"></span>
